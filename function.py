...
def পরবর্তী_দিনের_প্রেডিকশন(day):
    ...
    সর্বমোট_দাম_পরিবর্তন = 0
    সর্বমোট_দাম_বাড়ছে = 0
    সর্বমোট_দাম_কমছে = 0
    for ডাটা in সর্বমোট_দিন:  
        প্রত্যেকদিনের_দাম_পরিবর্তন = float(ডাটা['price_open']) - গড়
        if প্রত্যেকদিনের_দাম_পরিবর্তন >= 0:
            সর্বমোট_দাম_বাড়ছে = সর্বমোট_দাম_বাড়ছে + প্রত্যেকদিনের_দাম_পরিবর্তন
        else:
            সর্বমোট_দাম_কমছে = সর্বমোট_দাম_কমছে + প্রত্যেকদিনের_দাম_পরিবর্তন
        print(প্রত্যেকদিনের_দাম_পরিবর্তন)
       
    
    সর্বমোট_দাম_পরিবর্তন = সর্বমোট_দাম_বাড়ছে + abs(সর্বমোট_দাম_কমছে)
    print(সর্বমোট_দাম_পরিবর্তন)
    গড়_দাম_পরিবর্তন = সর্বমোট_দাম_পরিবর্তন/len(সর্বমোট_দিন)
    শতকরা_দাম_পরিবর্তন = গড়_দাম_পরিবর্তন/100
 
    if সর্বমোট_দাম_বাড়ছে >= abs(সর্বমোট_দাম_কমছে) : 
        return "{:.2f}% দাম বাড়বে".format(abs(শতকরা_দাম_পরিবর্তন))      
    else:
        return "{:.2f}% দাম কমবে".format(abs(শতকরা_দাম_পরিবর্তন))
   
ফলাফল_১ = পরবর্তী_দিনের_প্রেডিকশন(7)        
